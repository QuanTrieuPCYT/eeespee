...
Unlike [tuya-convert](https://github.com/ct-open-source/tuya-convert), [tuya-cloudcutter](https://github.com/tuya-cloudcutter/tuya-cloudcutter) **does not** backup your original firmware. Please resort to hardware flashing if you ever want to use Tuya firmware again!\
